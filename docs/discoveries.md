...
|---|---|---|---|---|
| [DISC-001](#disc-001) | YDB/IRIS list-function abbreviations missing from `grammar-surface.json` | tree-sitter-m-vscode test-routine authoring, 2026-04-26 | m-standard ([`docs/build-log.md` BL-014](../../m-standard/docs/build-log.md#bl-014)) | open — needs sweep across all `$LIST*` canonicals |
